...
New in this version
-------------------
* **Windows OCR** – uses the built-in Windows.Media.Ocr engine (via the *winsdk*
  package) instead of Tesseract; recognised text can be edited and optionally
  burned back onto the picture.
...
--------------------------
winsdk  – Python projection for Windows SDK (`pip install winsdk`)
Pillow – image handling
opencv-python – Gaussian blur
reportlab – PDF export
PyQt5 – GUI

References (sources embedded for reproducibility)
-------------------------------------------------
[1] winsdk import conventions :contentReference[oaicite:0]{index=0}
[2] winsdk PyPI and installation :contentReference[oaicite:1]{index=1}
[3] winsdk GitHub repository notes :contentReference[oaicite:2]{index=2}
[4] CryptographicBuffer.DecodeFromBase64String API :contentReference[oaicite:3]{index=3}
"""
...
class ImageEditor(QtWidgets.QMainWindow):
    ...
    def ocr_edit(self):
        ...
        # Replaced getsize_multiline with manual per-line height calculation
